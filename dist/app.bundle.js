...
/***/ function(module, exports, __webpack_require__) {
	...
	var _basic = __webpack_require__(300);

	var _basic2 = _interopRequireDefault(_basic);

	var _suspended = __webpack_require__(301);

	var _suspended2 = _interopRequireDefault(_suspended);

	var _iteratingBy = __webpack_require__(302);

	var _iteratingBy2 = _interopRequireDefault(_iteratingBy);

	var _otherGenerator = __webpack_require__(303);

	var _otherGenerator2 = _interopRequireDefault(_otherGenerator);

	var _theOldSchool = __webpack_require__(304);
	...
	(0, _theOldSchool.theOldSchoolWay)();
	(0, _async.theNewSchoolWay)();
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.theOldSchoolWay = undefined;

	__webpack_require__(1);

	var theOldSchoolWay = exports.theOldSchoolWay = function theOldSchoolWay() {
	  return fetch('http://ron-swanson-quotes.herokuapp.com/v2/quotes').then(function (response) {
	    if (response.ok) return response.text();else throw new Error(response.status);
	  }).then(function (quote) {
	    console.log(quote);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.theNewSchoolWay = undefined;

	var theNewSchoolWay = exports.theNewSchoolWay = function () {
	  ...
	  return function theNewSchoolWay() {
